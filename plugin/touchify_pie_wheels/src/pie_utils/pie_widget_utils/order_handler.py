...
from touchify_pie_wheels.src.custom_components import BaseWidget
from touchify_pie_wheels.src.composer_utils import CirclePoints
...
from touchify_pie_wheels.src.pie_utils.pie_widget_utils.widget_holder import WidgetHolder
