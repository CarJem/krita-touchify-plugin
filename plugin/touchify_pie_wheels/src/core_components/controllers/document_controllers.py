...
from touchify.src.api_krita.wrappers import Node
from touchify_pie_wheels.src.composer_utils.label import LabelText
...
class DocumentBasedController:
    ...
    def refresh(self) -> None:
        ...
        document = KritaAPI.get_active_document()
        if document is None:
