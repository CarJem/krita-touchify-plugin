...
def load_grids_data() -> tuple[list["GridInfo"], int]:
    ...
    json_str = KritaSettings.readSetting(TouchifyEnv.SettingsPath.QUICK_ACTIONS, "grid_config", "")
    grid_config: GridConfig = JsonExtensions.loadClass(json_str, GridConfig)
