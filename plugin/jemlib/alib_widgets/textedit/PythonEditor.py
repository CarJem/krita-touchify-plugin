...
class PythonEditor(QPlainTextEdit):
    ...
    class LineNumberArea(QWidget):
        ...
        def __init__(self, editor: "PythonEditor"):
            super(PythonEditor.LineNumberArea, self).__init__(editor)
    ...
    def resizeEvent(self, event):
        super(PythonEditor, self).resizeEvent(event)
        ...
        self.lineNumberArea.setGeometry(QRect(qRect.left(),
                                              qRect.top(),
    ...
    def wheelEvent(self, e):
        ...
        if e.modifiers() == Qt.ControlModifier:
            ...
            super(PythonEditor, self).wheelEvent(e)
    ...
    def keyPressEvent(self, e):
        ...
        if (e.key() == Qt.Key_Tab):
            ...
            super(PythonEditor, self).keyPressEvent(e)
            self.autoindent()
        else:
            super(PythonEditor, self).keyPressEvent(e)
