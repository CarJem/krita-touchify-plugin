...
class ResourcePack:
    ...
    def __defaults__(self):
        ...
        self.menus: TypedList[TriggerContextMenu] = []
        ...
        self.shelves: TypedList[ToolshelfData] = []
    ...
    def propertygrid_listload(self):
        ...
        self.menus = TypedList(self.menus, TriggerContextMenu)
        ...
        self.shelves = TypedList(self.shelves, ToolshelfData)
        ...
        try:
            ...
            for contentName in contents:
                ...
                if os.path.isfile(contentPath) and contentName == "metadata.json":
                    ...
                    self.menus = loadItems(contentPath, TriggerContextMenu)
                    ...
                    self.shelves = loadItems(contentPath, ToolshelfData)
