...
from touchify.src.api_composer.abstractions.preset_pie_config import PresetPieConfig
...
class TouchifyPieMenu(ComposerPieMenu):
    ...
    def generate(data: PieWheelData):
        ...
        from touchify.src.api_composer.abstractions.pie_controller import PieActionController
