...
class CfgTouchifyActionPanel:
    ...
    context_menu_actions: TypedList["CfgTouchifyActionPanel"] = []
    ...
    def __init__(self, **args) -> None:
        ...
        self.context_menu_actions = Extensions.list_assignment(context_menu_actions, CfgTouchifyActionPanel)
    ...
    def forceLoad(self):
        self.context_menu_actions = TypedList(self.context_menu_actions, CfgTouchifyActionPanel)
