...
class TriggerButton(QToolButton):
    ...
    def __init__(self, parent = None):
        super(TriggerButton, self).__init__(parent)
        ...
        self.trigger_mode = TriggerButton.TriggerMode.OnClick
    ...
    def onToolboxButtonSwap(self, ac: QAction):
        ...
        self.setTrigger(ac.trigger, TriggerButton.TriggerMode.OnClick)
