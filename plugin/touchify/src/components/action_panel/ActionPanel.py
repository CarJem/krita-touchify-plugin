...
from ..toolshelf.buttons.ToolshelfDockerButtons import ToolshelfDockerButton, ToolshelfDockerButtons
...
class ActionPanel(QWidget):
    def __init__(self, cfg: List[CfgTouchifyAction], parent: QWidget=None,):
        ...
        self.bar = ToolshelfDockerButtons(self)
    ...
    def updateButton(self, btn: ToolshelfDockerButton, action: QAction, useIcon: bool):
        btn.setChecked(action.isChecked())
        if useIcon:
            btn.setIcon(action.icon())
    
    def registerAction(self, btn: ToolshelfDockerButton, action: QAction, useIcon: bool):
