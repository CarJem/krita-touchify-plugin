...
try:
    ...
    import templates
    from touchify.src.components.shortcut_composer.pie_wheel.PieActionController import PieActionController
    from touchify.src.components.shortcut_composer.pie_wheel.PieMenu import PieMenu
