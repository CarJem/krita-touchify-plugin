...
class Filetypes:
    ...
    def generateFiletypeFilter():
        ...
        imgFormats = REFERENCE_FILETYPE_DATA["file_static"]
        imgFormats += REFERENCE_FILETYPE_DATA["file_anima"]
        imgFormats += REFERENCE_FILETYPE_DATA["file_vector"]
...
REFERENCE_FILETYPE_DATA = Filetypes.getRefrenceFiletypeData()